...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("RustDeskModified".to_owned());
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["192.168.0.47"];
pub const RS_PUB_KEY: &str = "7wpYJEAefpCpZwHHbhIAS4LT7JpalbSJYu3NM7vKAsU=";
